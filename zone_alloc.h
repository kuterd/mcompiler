...
//FIXME: Currently we cannot handle allocations bigger than 4kb - sizeof(struct zone_header) in size.
...
// Rather than freeing each object individually we can free all allocations at once.
// This simplify the memory management and also makes it faster for small allocations.
//
