...
#include <stdio.h>
/*
basic_block_t* create_test_block(struct ir_, fncontext *ctx, function_t *fn,
basic_block_t *prev) { basic_block_t *block = block_new(ctx, fn); inst_jump_t
*jmp = inst_new_jump(ctx, block); block_insert(prev, &jmp->inst);
}
*/
